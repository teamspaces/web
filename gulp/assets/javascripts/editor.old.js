(function(){
  ...
  Editor.prototype.init = function(attach_to, options) {
    ...
    // TODO: control flow
    // fetchPageRevision
    // fetchPageRevisionAuthors
    // authorizeAccess
    // drawUIActions # depends on what I'm authorized to do.
    // connectShareDB # if I have access to this
    //
    // EVENTS:
    // on('message') addMyselfToPageRevisionAuthors (unless already there)

    // DISCARD
    // How will this work and affect others??

    // PUBLISH
    // Update PageRevision published=true (quill.getContents?)
