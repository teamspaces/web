...
Devise.setup do |config|
  ...
  #if user is not authenticated, redirect to root_url instead of new_user_session_path
  ...
  config.http_authentication_realm = 'Spaces'
  ...
  config.allow_unconfirmed_access_for = nil #always
