...
describe User::UpdateSettingsForm, :model do
  ...
  describe "validations" do
    ...
    describe "password" do
      it "validates presence" do
        form = subject.new(user: user, params: { password: "", password_confirmation: "" })
        form.valid?
      ...
      it "validates confirmation" do
        form = subject.new(user: user, params: { password: "dos", password_confirmation: "uno" })
    ...
    describe "email" do
      it "validates presence" do
        form = subject.new(user: user, params: { email: "" })
        form.valid?
  ...
  describe "#save" do
    ...
    it "updates user attributes" do
      form = subject.new(user: user, params: { last_name: "La Fuente" })
    ...
    describe "name changes" do
      ...
      context "user has generated avatar" do
        it "updates avatar" do
          ...
          subject.new(user: user_with_generated_avatar, params: { first_name: "Martinez" }).save
        end
      end
    end
  end
