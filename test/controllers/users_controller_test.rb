  ...
  describe "#update" do
    context "with valid attributes" do
      ...
      describe "slack user" do
        ...
        it "does not allow to update email or password" do
          ...
          patch user_url(subdomain: slack_user.teams.first.subdomain), params: { user_update_settings_form: user_params }
          slack_user.reload
    ...
    context "with invalid attributes" do
      it "does not update attributes" do
        ...
        patch user_url(subdomain: team.subdomain), params: { user_update_settings_form: invalid_user_params }
        user.reload
